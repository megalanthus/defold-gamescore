local M = {
    ...
    fullscreen_open = 0xFF60,
    fullscreen_close = 0xFF61,
    fullscreen_change = 0xFF62,
    documents_open = 0xFF70,
    documents_close = 0xFF71,
    documents_fetch = 0xFF72,
    documents_fetch_error = 0xFF73,
}
