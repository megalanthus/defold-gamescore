...
-- приложение
M["app"] = {
    title = sys.get_config("project.title"),
    description = sys.get_config("gamescore.description"),
    image = sys.get_config("gamescore.image"),
    url = ""
}

-- платформа
M["platform"] = {
    type = sys.get_sys_info().system_name,
...
M["leaderboard.fetchPlayerRating"] = {
    ...
    player = {
        removed = false,
        projectId = sys.get_config("gamescore.id"),
        active = true,
        id = 0,
        score = 0,
        name = "",
...
M.achievement_data = {
    achievements = {
        {
            iconSmall = "https://cdn.eponesh.com/static/48x48/images/achievements/flash.png",
            id = 424,
            rare = "COMMON",
            name = "test achiv",
            description = "test achievement desc",
            icon = "https://cdn.eponesh.com/static/256x256/images/achievements/flash.png",
            tag = "my_achiv" }
    },
    playerAchievements = {
        {
